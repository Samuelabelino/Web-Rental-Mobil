...
<body>
  ...
  $sql = "SELECT rumah.*, merek.* from rumah, merek WHERE merek.id_merek=rumah.id_merek AND rumah.id_rumah='$vhid'";
      ...
      <section class="listing-detail">
        <div class="container">
          <div class="listing_detail_head row">
            <div class="col-md-9">
              <h2><?php echo htmlentities($result['nama_merek']); ?>, <?php echo htmlentities($result['nama_rumah']); ?></h2>
            </div>
            <div class="col-md-3">
              ...
              <div class="main_features">
                <ul>
                  ...
                  <li> <i class="fa fa-cogs" aria-hidden="true"></i>
                    <h5><?php echo htmlentities($result['panjang']); ?></h5>
                    <p>Tipe Ukuran</p>
                  </li>

                  <li> <i class="fa fa-user-plus" aria-hidden="true"></i>
                    <h5><?php echo htmlentities($result['kamar']); ?></h5>
                    <p>Kamar</p>
                  </li>
                </ul>
              </div>
          ...
          <div class="similar_cars">
            ...
            <div class="row">
              <?php
              $bid = $_SESSION['brndid'];
              $sql1 = "SELECT tblrumah.*, tblbrands.*from tblrumah, tblbrands WHERE tblbrands.id_merek=tblrumah.RumahBrand AND tblrumah.RumahBrand='$bid'";
              ...
              ?>
                  ...
                  <div class="col-md-3 grid_listing">
                    <div class="product-listing-m gray-bg">
                      <div class="product-listing-img"> <a href="rumah-details.php?vhid=<?php echo htmlentities($result['id']); ?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result['Vimage1']); ?>" class="img-responsive" alt="image" /> </a>
                      </div>
                      <div class="product-listing-content">
                        <h5><a href="rumah-details.php?vhid=<?php echo htmlentities($result['id']); ?>"><?php echo htmlentities($result['BrandName']); ?> , <?php echo htmlentities($result['RumahTitle']); ?></a></h5>
                        <p class="list-price"><?php echo htmlentities(format_rupiah($result['PricePerDay'])); ?></p>

                        <ul class="features_list">

                          <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result['KamarCapacity']); ?> seats</li>

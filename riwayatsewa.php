...
<![endif]-->
	...
	<body>
		...
		$sql1 	= "SELECT booking.*,rumah.*, merek.*, users.* FROM booking,rumah,merek,users WHERE booking.id_rumah=rumah.id_rumah 
			AND merek.id_merek=rumah.id_merek and booking.email=users.email and booking.email='$email'";
				...
				<table class="table table-striped table-bordered">
					<thead>
						<tr>
							...
							<th width="132">Nama rumah</th>
							<th width="80">Tgl. Mulai</th>
							<th width="100">Tgl. Selesai</th>
							<th width="50">Durasi</th>
							<th width="100">Biaya rumah</th>
							<th width="110">Biaya Penyewa</th>
			...
			AND merek.id_merek=rumah.id_merek and booking.email=users.email and booking.email='$email'";
					...
					?>
							<tr>
								...
								<td><?php echo $result['nama_rumah']; ?></td>

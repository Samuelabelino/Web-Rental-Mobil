...
<![endif]-->
	...
	<body>
		...
		<?php
		$kode = $_GET['kode'];
		$sql1 	= "SELECT booking.*,rumah.*, merek.* FROM booking,rumah,merek WHERE booking.id_rumah=rumah.id_rumah AND merek.id_merek=rumah.id_merek and booking.kode_booking='$kode'";
		$query1 = mysqli_query($koneksidb, $sql1);
		$result = mysqli_fetch_array($query1);
		$harga	= $result['harga'];
		$durasi = $result['durasi'];
		$totalrumah = $durasi * $harga;
		$penyewacharges = $result['penyewa'];
					...
					<div class="col-md-12 col-sm-10">
						<form method="post" name="sewa" onSubmit="return valid();">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="rumah" value="<?php echo $result['kode_booking']; ?>" readonly>
							</div>
							<input type="hidden" class="form-control" name="vid" value="<?php echo $vid; ?>" required>
							<div class="form-group">
								<label>Rumah</label>
								<input type="text" class="form-control" name="rumah" value="<?php echo $result['nama_merek'];
																							echo ", ";
																							echo $result['nama_rumah']; ?>" readonly>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>Biaya Penyewa (<?php echo $durasi; ?> Hari)</label><br />
								<input type="hidden" class="form-control" name="biayapenyewa" value="<?php echo $penyewacharges; ?>" readonly>
								<input type="text" class="form-control" name="penyewa" value="<?php echo format_rupiah($penyewacharges); ?>" readonly>
							</div>
							<div class="form-group">

...
if ($_GET) {
	$Kode = $_GET['code'];
	$sqlsewa = "SELECT booking.*,rumah.*,merek.*,users.* FROM booking,rumah,merek,users WHERE booking.id_rumah=mobil.id_rumah
				AND merek.id_merek=rumah.id_merek AND users.email=booking.email AND booking.kode_booking='$Kode'";
...
<body>
	<div id="section-to-print">
		...
		<table width="100%">
			...
			<tr>
				<td width="20%"><b>Rumah</b></td>
				<td width="2%"><b>:</b></td>
				<td width="78%"><?php echo $result['nama_merek']; ?>, <?php echo $result['nama_rumah']; ?></td>
			</tr>
			<tr>
				<td colspan="3">&nbsp;</td>
			</tr>
			...
			<tr>
				<td width="20%"><b>Biaya Penyewa</b></td>
				<td width="2%"><b>:</b></td>
				<td width="78%"><?php echo $result['penyewa']; ?></td>
			</tr>
			<tr>
				<td colspan="3">&nbsp;</td>
			</tr>
			<tr>
				<td width="20%"><b>Biaya Penyewa</b></td>
				<td width="2%"><b>:</b></td>
				<td width="78%"><?php echo $biayarumah; ?></td>
			</tr>
			<tr>
				<td colspan="3">&nbsp;</td>
			</tr>

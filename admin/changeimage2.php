...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['update'])) {
		...
		$sql = "update rumah set image2='$image2' where id_rumah='$id'";
...
?>
	...
	<head>
		...
		<title>Sewa Rumah | Admin Update Image 2</title>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title">Gambar Rumah 2</h2>

							<div class="row">
								<div class="col-md-10">
									<div class="panel panel-default">
										<div class="panel-heading">Gambar Rumah 2 Details</div>
										<div class="panel-body">
											<form method="post" class="form-horizontal" enctype="multipart/form-data">

												<div class="form-group">
													<label class="col-sm-4 control-label">Gambar Rumah 2 Sekarang</label>
													<?php
													$id = intval($_GET['imgid']);
													$sql = "SELECT image2 from rumah where id_rumah='$id'";
													$query	= mysqli_query($koneksidb, $sql);
													$cnt = 1;

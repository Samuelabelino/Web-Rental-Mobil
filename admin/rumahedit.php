...
?>
	...
	<head>
		...
		<title>Sewa Rumah | Admin Edit Info Rumah</title>
		...
		<script type="text/javascript">
			function valid(theform) {
				pola_nama = /^[a-zA-Z]*$/;
				if (!pola_nama.test(theform.rumahtitle.value)) {
					alert('Hanya huruf yang diperbolehkan untuk Nama Rumah!');
					theform.rumahtitle.focus();
					return false;
				}
				return (true);
			}
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title">Edit Rumah</h2>

							<div class="row">
								<div class="col-md-12">
									<div class="panel panel-default">
										<div class="panel-heading">Form Edit Rumah</div>
										<div class="panel-body">
											<?php
											$id = intval($_GET['id']);
											$sql = "SELECT rumah.*,merek.* FROM rumah, merek WHERE rumah.id_merek=merek.id_merek AND rumah.id_rumah='$id'";
											$query = mysqli_query($koneksidb, $sql);
											$result = mysqli_fetch_array($query);
											?>

											<form method="post" class="form-horizontal" name="theform" action="rumaheditact.php" onsubmit="return valid(this);" enctype="multipart/form-data">
												<div class="form-group">
													<label class="col-sm-2 control-label">Nama rumah<span style="color:red">*</span></label>
													<div class="col-sm-4">
														<input type="hidden" name="id" class="form-control" value="<?php echo $id; ?>" required>
														<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result['nama_rumah']); ?>" required>
													</div>
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">Deskripsi rumah<span style="color:red">*</span></label>
													<div class="col-sm-4">
														<textarea class="form-control" name="vehicalorcview" rows="3" required><?php echo htmlentities($result['deskripsi']); ?></textarea>
													</div>
													<label class="col-sm-2 control-label">No. Rumah<span style="color:red">*</span></label>
													<div class="col-sm-4">
														<input type="text" name="nomor" class="form-control" value="<?php echo htmlentities($result['nomor']); ?>" required>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<label class="col-sm-2 control-label">Jenis Rumah<span style="color:red">*</span></label>
													<div class="col-sm-4">
												...
												<div class="form-group">
													...
													<label class="col-sm-2 control-label">Jumlah Kamar<span style="color:red">*</span></label>
													<div class="col-sm-4">
														<input type="text" name="kamarcapacity" class="form-control" value="<?php echo htmlentities($result['kamar']); ?>" required>
													</div>
												</div>
												...
												<div class="form-group">
													<div class="col-sm-4">
														...
														<a href="changeimage1.php?imgid=<?php echo htmlentities($result['id_rumah']) ?>">Ganti Gambar 1</a>
													</div>
													<div class="col-sm-4">
														Gambar 2<img src="img/vehicleimages/<?php echo htmlentities($result['image2']); ?>" width="300" height="200" style="border:solid 1px #000">
														<a href="changeimage2.php?imgid=<?php echo htmlentities($result['id_rumah']) ?>">Ganti Gambar 2</a>
													</div>
													<div class="col-sm-4">
														Gambar 3<img src="img/vehicleimages/<?php echo htmlentities($result['image3']); ?>" width="300" height="200" style="border:solid 1px #000">
														<a href="changeimage3.php?imgid=<?php echo htmlentities($result['id_rumah']) ?>">Ganti Gambar 3</a>
													</div>
												</div>
												...
												<div class="form-group">
													<div class="col-sm-4">
														...
														<a href="changeimage4.php?imgid=<?php echo htmlentities($result['id_rumah']) ?>">Ganti Gambar 4</a>
													</div>
													<div class="col-sm-4">
														Gambar 5
														<?php if ($result['image5'] == "") {
															...
															<a href="changeimage5.php?imgid=<?php echo htmlentities($result['id_rumah']) ?>">Ganti Gambar 5</a>
														<?php } ?>
													</div>
												</div>

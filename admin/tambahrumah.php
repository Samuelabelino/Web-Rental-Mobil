...
?>
	...
	<head>
		...
		<title>Sewa Rumah | Admin Tambah Mobil</title>
		<!-- Font awesome -->
							...
							<div class="row">
								<div class="col-md-12">
									<div class="panel panel-default">
										<div class="panel-heading">Form Tambah Rumah</div>
										<div class="panel-body">
											<form method="post" name="theform" action="tambahmobilact.php" class="form-horizontal" onsubmit="return valid(this);" enctype="multipart/form-data">
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">Harga /Bulan<span style="color:red">*</span></label>
													<div class="col-sm-4">
												...
												<div class="form-group">
													...
													<label class="col-sm-2 control-label">Kapasitas Kamar<span style="color:red">*</span></label>
													<div class="col-sm-4">

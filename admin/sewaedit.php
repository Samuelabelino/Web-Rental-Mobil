...
?>
	...
	<head>
		...
		<title>Gading Mas Rumah Rental Portal | Admin Edit Sewa Rumah</title>
								...
								<div class="col-md-12">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<?php
											$id = $_GET['id'];
											$sqlsewa = "SELECT booking.*,rumah.*,merek.*,users.* FROM booking,rumah,merek,users WHERE booking.id_rumah=rumah.id_rumah
													AND merek.id_merek=rumah.id_merek AND users.email=booking.email AND booking.kode_booking ='$id'";
											$querysewa = mysqli_query($koneksidb, $sqlsewa);
											$result = mysqli_fetch_array($querysewa);
											$biayarumah = $result['durasi'] * $result['harga'];
											$total = $result['penyewa'] + $biayarumah;
											?>
										...
										<div class="panel-body">
											<form>
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="namarumah" class="form-control" value="<?php echo $result['nama_rumah']; ?>" required readonly>
													</div>
												</div>
												<br />
												<div class="form-group">
													<label class="col-sm-2 control-label">Biaya Penyewa</label>
													<div class="col-sm-4">
														<input type="text" name="penyewa" class="form-control" value="<?php echo format_rupiah($result['penyewa']); ?>" required readonly>
													</div>
												</div>
												<br />
												<div class="form-group">
												...
												<br />
												<div class="form-group">
													<label class="col-sm-2 control-label">Biaya Rumah</label>
													<div class="col-sm-4">
														<input type="text" name="biayarumah" class="form-control" value="<?php echo format_rupiah($biayarumah); ?>" required readonly>
													</div>
												</div>
												<br />
												<div class="form-group">

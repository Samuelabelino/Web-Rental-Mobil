...
?>
	...
	<head>
		...
		<title>Sewa Rumah | Admin Dashboard</title>
											...
											<div class="panel panel-default">
												<div class="panel-body bk-success text-light">
													<div class="stat-panel text-center">
														...
														$totalmobil = mysqli_num_rows($query1);
														?>
														<div class="stat-panel-number h1 "><?php echo htmlentities($totalmobil); ?></div>
														<div class="stat-panel-title text-uppercase">Jumlah Rumah</div>
													</div>
												</div>
												<a href="rumah.php" class="block-anchor panel-footer text-center">Rincian &nbsp; <i class="fa fa-arrow-right"></i></a>
											</div>
										</div>
